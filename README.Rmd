...
# LineageHomology
  ...
  * [Example](#example)
  * [Tutorial and gallery of plotting methods](#for-a-more-advanced-example-and-illustrations-of-some-of-the-plotting-methods-see)

<!-- badges: start -->
<!-- badges: end -->

LineageHomology provides a set of functions that analyzes the outputs from an ancestral state reconstruction. Following  du Plessis et al. (2021) (10.1126/science.abf2946) to estimate if taxa have inhereted traits by homology or if their character state represents a novelty wrt. the other taxa in the tree. 
