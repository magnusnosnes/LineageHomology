...
LineageHomology provides a set of functions that can analyze the outputs from ancestral state reconstruction to estimate if taxa have inhereted traits by homology 
