...
LineageHomology provides a set of functions that analyzes the outputs from ancestral state reconstructions. LineageHomology counts transmission lineages according to state transitions between ancestral and descendant nodes that have a probability higher than 50 percent. The method is analogous to that introduced by du Plessis et al. (2021) (DOI: 10.1126/science.abf2946). The outputs contain descriptions of transmission lineages, tips where traits are inferred to be locally inherited (homologous traits or local transmissions depending on the context), and other useful summaries.
